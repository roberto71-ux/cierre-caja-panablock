...
def generate_report(fecha_str, facturas, recibos, bg, gb,
    ...
    # Fila 13: encabezado de la sub-sección
    ws.row_dimensions[13].height = 18
    ws.merge_cells('A13:D13')
    c13 = ws['A13']
    c13.value     = 'Desglose de Cobros por Forma de Pago'
    c13.font      = Font(name='Arial', bold=True, size=10, color=DARK_BLUE)
    c13.fill      = mk_fill('D9E1F2')
    c13.alignment = LA
    c13.border    = BRD

    # Filas 14-18: una fila por cada forma de pago

...
def generate_report(fecha_str, facturas, recibos, bg, gb,
    ...
    row_s1(9,  'Total Ventas del Día  (Contado + Crédito)',
           b='=B7+B17', c='=C7+C17', d='=D7+D17', bold=True, bg_color=LGRAY)
    ...
    row_s2(22, 'Pago a Proveedores',
           d=(total_gast if total_gast else None), bold=True, bg_color=LGRAY)

    spacer(23)

    # ── Sección 3 — MOVIMIENTOS DE BANCOS ──────────────────────────
    section_hdr(24, 'MOVIMIENTOS DE BANCOS')
    col_hdr(25, ['Descripción', 'Banco General', 'Global Bank', ''])

    row_s3(26, 'Saldo Anterior',
           b=bg['saldo_anterior'], c=gb['saldo_anterior'])
    row_s3(27, 'Depósitos según extracto bancario (efectivo, ACH, TC, Yappy)',
    ...
    row_s3(28, 'Egresos según extracto bancario',
           b=bg_egresos if bg_egresos else None,
           c=gb_egresos if gb_egresos else None)

    row_s3(29, 'Saldo Bancario al Final del Día',
           b='=B26+B27-B28', c='=C26+C27-C28',
           bold=True, bg_color=LGRAY)

    row_s3(30, 'Cheques en Circulación',
           b=cheques_bg if cheques_bg else None,
           c=cheques_gb if cheques_gb else None)

    row_s3(31, 'Saldo Bancario Real Conciliado',
           b='=B29-B30', c='=C29-C30',
           bold=True, bg_color=MGRAY)
    ws['D30'].border = NO_BORDER
    ...
    ws['A33'].value     = 'Firma: ___________________________'
    ws['A33'].font      = Font(name='Arial', size=11)
    ws['A33'].alignment = LA
    ...
    ws['A35'].value     = ('Generado automáticamente por Cierre de Caja — Grupo Panablock')
    ws['A35'].font      = Font(name='Arial', italic=True, size=9, color='595959')
    ws['A35'].alignment = LA
...
def generate_pdf_report(fecha_str, facturas, recibos, bg, gb,
    ...
    data1 = [
        ...
        # 4
        ['Total Ventas del Día  (Contado + Crédito)',
    ...
    style1 = TableStyle(
        ...
        # spans: fila 3 y 11 (A-C label, D valor); fila 4 sin span (4 cols con valores)
        + [('SPAN', (0, 3), (2, 3)),
           ('SPAN', (0, 11), (2, 11))]
